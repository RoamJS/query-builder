...
class Pointing extends StateNode {
  ...
  createArrowShape() {
    ...
    const util = this.editor.getShapeUtil<RelationShape>("relation");
...
export class BaseDiscourseRelationTool extends StateNode {
  static override id = "relation";
  static override initial = "idle";
  static override children = (): TLStateNodeConstructor[] => [Idle, Pointing];

  override shapeType = "relation";
}
