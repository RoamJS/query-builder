...
export const createSortIcon = (
  ...
  popoverWrapper.className = `bp3-popover-wrapper ${POPOVER_WRAPPER_CLASS} roamjs-sort-icon`;
            ...
            menuItemCallback(refContainer, (a, b) => {
              ...
              if (!aDate && !bDate) {
                if (/^page title$/i.test(dailyNoteSecondary)) {
                  ...
                  /^page title descending$/i.test(dailyNoteSecondary)
                ) {
...
export default runSortReferences;
